    ...
    <div className=" bg-gray-100">
      ...
      <section className="max-w-6xl mx-auto py-12 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <FeatureCard
            title="Collaboration"
            description="Work together with real-time updates and messaging."
          />
          <FeatureCard
            title="Progress Tracking"
            description="Monitor your project timeline and deadlines easily."
          />
          <FeatureCard
            title="Budget Control"
            description="Set and track budgets to avoid overspending."
          />
          <FeatureCard
            title="File Sharing"
            description="Upload and manage documents in one place."
          />
          <FeatureCard
            title="Analytics & Reports"
            description="Get insights with detailed project reports."
          />
        </div>
      </section>
    </div>
